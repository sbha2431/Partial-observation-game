...
The transition relation $T$ encodes the one-step move of both the target and the agent, where the target moves first and the agent moves second. For a state $(l_a,l_t)$ we define $\succs_t(l_a,l_t)$ as the set of successor locations of the target:
